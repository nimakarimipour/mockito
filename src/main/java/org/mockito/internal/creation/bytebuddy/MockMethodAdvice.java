...
public class MockMethodAdvice extends MockMethodDispatcher {
  ...
  public boolean isOverridden(Object instance, Method origin) {
    ...
    MethodGraph.Node node =
        methodGraph.locate(new MethodDescription.ForLoadedMethod(origin).asSignatureToken());
  ...
  private static class SerializableRealMethodCall implements RealMethod {
    ...
    public Object invoke() throws Throwable {
      ...
      Object previous =
          ((MockMethodAdvice) mockMethodDispatcher).selfCallInfo.replace(instanceRef.get());
      try {
            ...
            public void visitCode() {
              ...
              super.visitMethodInsn(
                  ...
                  Type.getMethodDescriptor(
                      Type.BOOLEAN_TYPE, Type.getType(String.class), Type.getType(Class.class)),
                  false);
              ...
              for (ParameterDescription parameter : instrumentedMethod.getParameters()) {
                ...
                if (parameter.getType().isPrimitive()) {
                  Type wrapper =
                      Type.getType(parameter.getType().asErasure().asBoxed().getDescriptor());
                  super.visitMethodInsn(
                      Opcodes.INVOKESTATIC,
