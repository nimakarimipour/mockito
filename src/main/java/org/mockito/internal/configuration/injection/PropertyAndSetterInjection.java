 ...
 *
 * <p><u>Algorithm :<br>
 * </u> for each field annotated by @InjectMocks
 *
 * <ul>
 ...
 * </ul>
 *
 * <p><u>Note:</u> If the field needing injection is not initialized, the strategy tries to create
 * one using a no-arg constructor of the field type.
 */
public class PropertyAndSetterInjection extends MockInjectionStrategy {

  private final MockCandidateFilter mockCandidateFilter =
      new TypeBasedCandidateFilter(new NameBasedCandidateFilter(new TerminalMockCandidateFilter()));
  ...
  private boolean injectMockCandidatesOnFields(
    ...
    for (Iterator<Field> it = orderedCandidateInjecteeFields.iterator(); it.hasNext(); ) {
      ...
      Object injected =
          mockCandidateFilter
              .filterCandidate(mocks, candidateField, orderedCandidateInjecteeFields, injectee)
              .thenInject();
      if (injected != null) {
