 ...
 *
 * <p>One of the key points of mocking library is proper verification/exception messages. All
 * messages in one place makes it easier to tune and amend them.
 *
 * <p>Reporter can be injected and therefore is easily testable.
 *
 * <p>Generally, exception messages are full of line breaks to make them easy to read (xunit plugins
 * take only fraction of screen on modern IDEs).
 */
public class Reporter {
  ...
  public static MockitoAssertionError tooManyActualInvocations(
      int wantedCount, int actualCount, DescribedInvocation wanted, List<Location> locations) {
